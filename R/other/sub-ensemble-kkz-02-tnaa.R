...
dat_season <- readRDS("data/future-trends/tnaa-crop-seasonal-mean.rds")
...
saveRDS(dat_selected_models, "data/sub-ensemble-kkz-tnaa-01-selected-models.rds")
saveRDS(dat_table, "data/sub-ensemble-kkz-tnaa-02-change-factors.rds")
