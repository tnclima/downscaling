...
dat_plot_tasmax <- dat_plot[variable == "tasmax" & bads_multi == F & 
                              metric != "bias_rel" & season == "JJA" &
                              bads_ds != "ds-qdm"] 
...
dat_plot_tasmax[metric == "bias", median(value), bads]
dat_plot_tasmax[metric == "bias", range(value), bads]


# dat_plot_pr[metric == "bias_rel", median(value), bads]
# dat_plot_pr[metric == "bias_rel", range(value), bads]

dat_plot_pr[metric == "mae", range(value), bads]
dat_plot_pr[metric == "mae", median(value), bads]
