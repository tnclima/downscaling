...
for(i in 1:nrow(dat_loop)){
  ...
  fn <- path("fig/validation-eval/singlevar/", 
...
for(i_var in c("tasmax", "tasmin", "pr")){
  ...
  ggsave(str_c("fig/validation-eval/singlevar-summary/", i_var, "-month-raw.png"),
  ...
  ggsave(str_c("fig/validation-eval/singlevar-summary/", i_var, "-month-diff.png"),
