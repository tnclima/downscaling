...
saveRDS(rbindlist(l_month), 
        "/home/climatedata/downscaling/validation-cv/rdata-summary-v2/eval-eobs-month.rds")

saveRDS(rbindlist(l_etccdi), 
        "/home/climatedata/downscaling/validation-cv/rdata-summary-v2/eval-eobs-etccdi.rds")
