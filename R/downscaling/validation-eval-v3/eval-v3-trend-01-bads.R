...
for(i in 1:nrow(dat_loop)){
  ...
  fn <- path("fig/validation-eval/trend-preservoddeven/", 
...
ggsave("fig/validation-eval/trend-preserv-summary/tasmax-hist-oddeven.png", 
...
ggsave("fig/validation-eval/trend-preserv-summary/tasmin-hist-oddeven.png", 
       gg1, width = 12, height = 4)
