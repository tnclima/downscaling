...
path_out <- "/home/climatedata/downscaling/validation-cv-reanalysis/data-daily-v6/ds-pcalm/"
...
n_cores <- 7 # parallel computation; bottleneck maybe disk access?
...
saveRDS(zz, "data/coef-pcalm-v6.rds")
